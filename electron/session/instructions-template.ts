/**
 * INSTRUCTIONS.md template for session bundles
 * This is a reusable, session-agnostic instruction file that explains
 * how to process KiwiGen session bundles for test generation.
 */

export const INSTRUCTIONS_TEMPLATE = `# KiwiGen - Session Bundle Instructions
